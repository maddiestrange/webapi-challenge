...
- [ ] Describe Middleware?
Custom functions, filters, or actions that run the HTTP request is complete and returns a result. Middleware is separated out from the main body of the function handling the request.

- [ ] Describe a Resource?
Something that is stored and accessed in the backend as an object.

- [ ] What can the API return to help clients know if a request was successful?
Returning status codes and json messages
